        ...
        >
          <div className="contact-main">
            ...
            <div className="contact-methods">
              <a href="mailto:business@emielster.dev" className="contact-card glass-card">
                ...
                <div className="contact-info">
                  ...
                  <span className="contact-value">business@emielster.dev</span>
                </div>
              </a>

              <a href="https://discordapp.com/users/1008094806376988782" className="contact-card glass-card">
                ...
                <div className="contact-info">
                  ...
                  <span className="contact-value">@emielsterdev</span>
                </div>
              </a>
            </div>
